...
- Use **Pause scheduling** when a healthy account should stop receiving traffic for a short window. The action temporarily opens the account circuit for five minutes without disabling or deleting the account. Use **Reset local status** to clear the pause early.
