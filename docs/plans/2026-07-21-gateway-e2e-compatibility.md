...
| `local_tests` | complete | Mock PostgreSQL/upstream, raw HTTP, SDK, streaming, fallback, affinity, proxy, response-bound, cancellation, and artifact-redaction coverage passes. Commits `6da9ec0`, `3046c49`, `06da041`, `49363aa`, `226951f`, and `bf0da37` add real socket, transport, process, persisted-affinity, failure-recovery, and unsafe-override acceptance tests. Real OAuth/Codex and reverse-proxy checks remain under `operator_acceptance`. |
