...
func TestMainWiresProviderAccountAutoTestRunner(t *testing.T) {
	...
	for _, want := range []string{
		...
		"admin.NewAPIKeyBudgetMaintenance",
		"startBackground(\"api_key_budget_maintenance\", apiKeyBudgetMaintenance.Run)",
		...
		"updatecheck.NewService",
		"startBackground(\"update_check\", updateChecker.Run)",
		...
		"autoTestRunner, requestLogRetentionRunner, responseAffinityRetentionRunner, requestLogWriteMonitor, apiKeyBudgetMaintenance, updateChecker, os.DirFS(\"frontend/build\")",
	...
	for _, forbidden := range []string{
		...
		"go apiKeyBudgetMaintenance.Run(",
